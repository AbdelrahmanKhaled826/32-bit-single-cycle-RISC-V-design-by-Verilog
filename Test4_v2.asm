...
#################################
arith_add_imm:
	addi  $t0, $a0, 0xAAAA 			# $t0 = 0x5A5A_A5A5+0xFFFF_AAAA = 0x1_A5A5_0504,	# $t0 = (-1,515,890,086+(-21,846)) = -1,515,911,932 = -0x5A5A_FAFC)		
	addiu $t1, $a0, 0xAAAA 			# $t1 = 0x5A5A_A5A5+0xFFFF_AAAA = 0x1_A5A5_0504,	# $t1 = (+2,779,077,210+4,294,945,450 = 5,810,835,535)
	lui $t2, 0xA5A5
	ori $t2, $t2, 0x0504
	beq $t0, $t2, NEXT_ADD
	j END_ADD
